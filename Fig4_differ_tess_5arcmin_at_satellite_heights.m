...
%computation nodes for the tesseroids of 5 min * 5 min at 200,400 and
%600 km, respectively.
...
ObservH200km_Order2=abstract(tess_5minx5min_dr2km_ObservH200km_Order2);
ObservH200km_Order5=abstract(tess_5minx5min_dr2km_ObservH200km_Order5);
ObservH400km_Order2=abstract(tess_5minx5min_dr2km_ObservH400km_Order2);
ObservH400km_Order5=abstract(tess_5minx5min_dr2km_ObservH400km_Order5);
ObservH600km_Order2=abstract(tess_5minx5min_dr2km_ObservH600km_Order2);
ObservH600km_Order5=abstract(tess_5minx5min_dr2km_ObservH600km_Order5);
ObservH600km_Taylor=abstract(tess_5minx5min_dr2km_ObservH600km_Taylor);
ObservH400km_Taylor=abstract(tess_5minx5min_dr2km_ObservH400km_Taylor);
ObservH200km_Taylor=abstract(tess_5minx5min_dr2km_ObservH200km_Taylor);
ObservH600km_Prism=abstract(tess_5minx5min_dr2km_ObservH600km_PrismApproa);
ObservH400km_Prism=abstract(tess_5minx5min_dr2km_ObservH400km_PrismApproa);
ObservH200km_Prism=abstract(tess_5minx5min_dr2km_ObservH200km_PrismApproa);
...
title('The maximum difference of a_{3} at 200 km for tesseroids of 5''x5'' ','position',[40 0.1],'fontsize',20);
%subgraph name
...
ylabel({'Approximation error (mGal)'},'FontSize',fontsize_label);
xlabel({'The latitude of the observation point({\circ})'},'FontSize',fontsize_label);
title('The maximum difference of a_{3} at 400 km for tesseroids of 5''x5'' ','position',[40 0.1],'fontsize',20);
%subgraph name
text(-10.5,0.1,'b)','fontsize',fontsize_title);
...
ylabel({'Approximation error (mGal)'},'FontSize',fontsize_label);
xlabel({'The latitude of the observation point({\circ})'},'FontSize',fontsize_label);
title('The maximum difference of a_{3} at 600 km for tesseroids of 5''x5'' ','position',[40 0.1],'fontsize',20);
%subgraph name
text(-10.5,0.1,'c)','fontsize',fontsize_title);
